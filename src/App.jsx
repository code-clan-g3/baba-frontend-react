    ...
    <div className="bg-gray-100 min-h-screen flex flex-col items-center justify-center px-4">
      ...
      >
        ...
        <motion.p
          ...
          transition={{ duration: 0.8 }}
        >
          What if you had a Personal AI Assistant who talks to you like your Typical Nigerian Neighbor? Well now you can!<br /> Meet Baba's AI assistant that helps you simplify task and boost productivity with adequate fluency in pidgin as well as your native tongue and English
        </motion.p>
        <motion.div
        ...
        >
          {/* Get Started Button */}
          <button className="flex items-center justify-center gap-2 px-6 py-3 bg-teal-500 text-white rounded-lg hover:bg-teal-600 text-sm md:text-base">
